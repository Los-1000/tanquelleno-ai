...
LIMA_CALLAO_DIR = os.path.join(DATOS_DIR, "lima_callao")
...
F_HISTORICO_LIMA = os.path.join(LIMA_CALLAO_DIR, "historico_grifos_lima_callao.csv")
F_PREMIUM_LIMA = os.path.join(LIMA_CALLAO_DIR, "premium_lima_callao_20260918.csv")
...
F_MODELO_POSICION = os.path.join(MODELOS_DIR, "modelo_posicion_grifo.joblib")
